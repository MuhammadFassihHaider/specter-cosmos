...
import { Params } from "../specter/params";
import { Loan } from "../specter/loan";
import {
  PageRequest,
  PageResponse,
} from "../cosmos/base/query/v1beta1/pagination";

export const protobufPackage = "specter.specter";
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("specter.specter.Query", "Params", data);
    return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
  }

  Loan(request: QueryGetLoanRequest): Promise<QueryGetLoanResponse> {
    const data = QueryGetLoanRequest.encode(request).finish();
    const promise = this.rpc.request("specter.specter.Query", "Loan", data);
  ...
  LoanAll(request: QueryAllLoanRequest): Promise<QueryAllLoanResponse> {
    ...
    const promise = this.rpc.request("specter.specter.Query", "LoanAll", data);
    return promise.then((data) =>
